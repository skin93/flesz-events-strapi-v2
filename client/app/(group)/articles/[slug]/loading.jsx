  ...
  return (
    <main>
      <section className="my-6">
        ...
        <Skeleton className="w-full h-[50px] my-6 rounded-none" />
        <Skeleton className="w-full h-[3px] my-6" />
        <div className="grid grid-cols-1 xl:grid-cols-[50%_40%] gap-2 justify-between">
          <div className=" w-full">
            ...
            <Skeleton className="w-full h-[3px] my-6" />
            <Skeleton className="w-full h-[100px] my-6 rounded-none" />
            <Skeleton className="w-full h-[100px] my-6 rounded-none" />
            <Skeleton className="w-full h-[100px] my-6 rounded-none" />
            <Skeleton className="w-full h-[100px] my-6 rounded-none" />
            <Skeleton className="w-full h-[3px] my-6" />
          ...
          <div className="w-full flex-col justify-between items-start">
            <Skeleton className="w-[50%] h-[50px] rounded-none my-6" />
            <div className="grid grid-cols-1 sm:grid-cols-2 justify-center gap-4 mx-auto">
              <Skeleton className="aspect-video w-full 50 my-6 rounded-sm" />
              <Skeleton className="aspect-video w-full 50 my-6 rounded-sm" />
              <Skeleton className="aspect-video w-full 50 my-6 rounded-sm" />
            </div>
          </div>
