            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input
                      className="h-[100px] w- xl:h-[200px] bg-transparent text-white text-4xl xl:text-6xl ring-offset-0 border-0 focus-visible:ring-0 focus-visible:ring-transparent"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
